...
nohup python3 -m verl.trainer.main_ppo \
    ...
    data.train_files=${PROJECT_ROOT}/dataset/train/chatbot_arena_filter_2perm_think.parquet \
    data.val_files=${PROJECT_ROOT}/dataset/train/chatbot_arena_filter_2perm_think.parquet \
